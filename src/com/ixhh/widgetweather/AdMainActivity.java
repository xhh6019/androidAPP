...
public class AdMainActivity extends Activity {
	...
	TextView city,date,tem,weather,fengsu,fengsudengji,chuanyizhishu,chuanyiD,chuanyi48zhishu,chuanyi48D,xc,tr,ls,co,ag,cl;
	ImageView ico=null;
	Bitmap img=null;
	Context cont=null;
		...
		new AsyncTask<Void, Void, JSONObject>() {			
			...
			protected JSONObject doInBackground(Void... params) {
				...
				try {
					...
					e.printStackTrace();
					Toast.makeText(cont, "获取数据失败", Toast.LENGTH_LONG).show();
				}
				return jso;
			}
			@Override
